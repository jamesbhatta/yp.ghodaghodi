<!--Navbar-->
<nav class="navbar navbar-expand-lg navbar-dark cyan sticky-top scrolling-navbar z-depth-0">
...
<div class="collapse navbar-collapse" id="basicExampleNav">
  <ul class="navbar-nav mr-autos font-weight-bolder">
    ...
    <li class="nav-item {{ setActive('event.list') }} {{ setActive('event.view') }}">
      <a class="nav-link" href="{{ route('event.list') }}">Events</a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ setActive('features') }}" href="{{ route('features') }}">Features</a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ setActive('pricing') }}" href="{{ route('pricing') }}">Pricing</a>
    </li>
  </ul>

  <ul class="navbar-nav ml-auto font-weight-bolder">
    <li class="nav-item">
      <a class="nav-link" href="{{ route('listing') }}">Free Listing</a>
    </li>
    <li class="nav-item">
